...
export default class ChoosePlayerScene extends cc.Component {
    ...
    start () {
        ...
        this.playerOneReady.active = false;
        this.playerTwoReady.active = false;
        this.playerThreeReady.active = false;
        this.playerFourReady.active = false;
    ...
    update (dt) {
        ...
        if (this.playerNumber == 0) cc.find("Canvas/NextButton").getComponent(cc.Button).node.active = false;
        else cc.find("Canvas/NextButton").getComponent(cc.Button).node.active = true;
    }
}
